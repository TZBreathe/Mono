...
function [obj, voltModel] = Diffusion2P_Param_Optim_Function(k,currData,timeData,socData,voltData,tempData,OcvLuts)
...
voltModel = diffusion2P_model(k,currData,timeData,socData,tempData,OcvLuts);
