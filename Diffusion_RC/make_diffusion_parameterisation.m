...
lowBound = [k0(1)/2;  k0(2)/5;  k0(3)/5;  700;   k0(5)*1;  5000;  5000;  5000];
upBound =  [k0(1)*2;  k0(2)*3;  k0(3)*3;  2500;  k0(5)*1;  13000; 13000; 13000];
...
maxHybridFminIters = 100; % Max number of IPA iterations
